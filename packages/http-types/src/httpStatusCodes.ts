 ...
 * upon.
 *
 * @see [Documentation → RFC 7231 §6.2.1](https://datatracker.ietf.org/doc/html/rfc7231#section-6.2.1)
 ...
 * response.
 *
 * @see [Documentation → RFC 7231 §6.2.2](https://datatracker.ietf.org/doc/html/rfc7231#section-6.2.2)
 * @see [Specification → RFC 7231](https://webconcepts.info/specs/IETF/RFC/7231)
 */
 ...
 * completed.
 *
 * @see [Documentation → RFC 2518 §10.1](https://datatracker.ietf.org/doc/html/rfc2518#section-10.1)
 ...
 *
 * @see [Documentation → RFC 8297 §2](https://datatracker.ietf.org/doc/html/rfc8297#section-2)
 * @see [Documentation → WHATWG HTML Standard](https://html.spec.whatwg.org/multipage/semantics.html#early-hints)
 * @see [Specification → RFC 8297](https://webconcepts.info/specs/IETF/RFC/8297)
 ...
 * request method.
 *
 * @see [Documentation → RFC 7231 §6.3.1](https://datatracker.ietf.org/doc/html/rfc7231#section-6.3.1)
 * @see [Specification → RFC 7231](https://webconcepts.info/specs/IETF/RFC/7231)
 */
 ...
 *
 * @see [Documentation → RFC 7231 §6.3.2](https://datatracker.ietf.org/doc/html/rfc7231#section-6.3.2)
 * @see [Specification → RFC 7231](https://webconcepts.info/specs/IETF/RFC/7231)
 */
 ...
 *
 * @see [Documentation → RFC 7231 §6.3.3](https://datatracker.ietf.org/doc/html/rfc7231#section-6.3.3)
 * @see [Specification → RFC 7231](https://webconcepts.info/specs/IETF/RFC/7231)
 */
 ...
 *
 * @see [Documentation → RFC 7231 §6.3.4](https://datatracker.ietf.org/doc/html/rfc7231#section-6.3.4)
 * @see [Specification → RFC 7231](https://webconcepts.info/specs/IETF/RFC/7231)
 */
 ...
 * action was applied.
 *
 * @see [Documentation → RFC 7231 §6.3.5](https://datatracker.ietf.org/doc/html/rfc7231#section-6.3.5)
 * @see [Specification → RFC 7231](https://webconcepts.info/specs/IETF/RFC/7231)
 */
 ...
 * server.
 *
 * @see [Documentation → RFC 7231 §6.3.6](https://datatracker.ietf.org/doc/html/rfc7231#section-6.3.6)
 * @see [Specification → RFC 7231](https://webconcepts.info/specs/IETF/RFC/7231)
 */
 ...
 *
 * @see [Documentation → RFC 7233 §4.1](https://datatracker.ietf.org/doc/html/rfc7233#section-4.1)
 ...
 *
 * @see [Documentation → RFC 4918 §11.1](https://datatracker.ietf.org/doc/html/rfc4918#section-11.1)
 ...
 *
 * @see [Documentation → RFC 5842 §7.1](https://datatracker.ietf.org/doc/html/rfc5842#section-7.1)
 ...
 *
 * @see [Documentation → RFC 3229 §10.4.1](https://datatracker.ietf.org/doc/html/rfc3229#section-10.4.1)
 ...
 *
 * @see [Documentation → RFC 7231 §6.4.1](https://datatracker.ietf.org/doc/html/rfc7231#section-6.4.1)
 * @see [Specification → RFC 7231](https://webconcepts.info/specs/IETF/RFC/7231)
 */
 ...
 *
 * @see [Documentation → RFC 7231 §6.4.2](https://datatracker.ietf.org/doc/html/rfc7231#section-6.4.2)
 * @see [Specification → RFC 7231](https://webconcepts.info/specs/IETF/RFC/7231)
 */
 ...
 * future requests.
 *
 * @see [Documentation → RFC 7231 §6.4.3](https://datatracker.ietf.org/doc/html/rfc7231#section-6.4.3)
 * @see [Specification → RFC 7231](https://webconcepts.info/specs/IETF/RFC/7231)
 */
 ...
 *
 * @see [Documentation → RFC 7231 §6.4.4](https://datatracker.ietf.org/doc/html/rfc7231#section-6.4.4)
 * @see [Specification → RFC 7231](https://webconcepts.info/specs/IETF/RFC/7231)
 */
 ...
 *
 * @see [Documentation → RFC 7232 §4.1](https://datatracker.ietf.org/doc/html/rfc7232#section-4.1)
 ...
 *
 * @see [Documentation → RFC 7231 §6.4.5](https://datatracker.ietf.org/doc/html/rfc7231#section-6.4.5)
 * @see [Specification → RFC 7231](https://webconcepts.info/specs/IETF/RFC/7231)
 */
 ...
 *
 * @see [Documentation → RFC 7231 §6.4.6](https://datatracker.ietf.org/doc/html/rfc7231#section-6.4.6)
 * @see [Specification → RFC 7231](https://webconcepts.info/specs/IETF/RFC/7231)
 */
 ...
 * requests.
 *
 * @see [Documentation → RFC 7231 §6.4.7](https://datatracker.ietf.org/doc/html/rfc7231#section-6.4.7)
 * @see [Specification → RFC 7231](https://webconcepts.info/specs/IETF/RFC/7231)
 */
 ...
 * the enclosed URIs.
 *
 * @see [Documentation → RFC 7538 §3](https://datatracker.ietf.org/doc/html/rfc7538#section-3)
 * @see [Specification → RFC 7538](https://webconcepts.info/specs/IETF/RFC/7538)
 */
 ...
 * request routing).
 *
 * @see [Documentation → RFC 7231 §6.5.1](https://datatracker.ietf.org/doc/html/rfc7231#section-6.5.1)
 * @see [Specification → RFC 7231](https://webconcepts.info/specs/IETF/RFC/7231)
 */
 ...
 *
 * @see [Documentation → RFC 7235 §3.1](https://datatracker.ietf.org/doc/html/rfc7235#section-3.1)
 ...
 * future use.
 *
 * @see [Documentation → RFC 7231 §6.5.2](https://datatracker.ietf.org/doc/html/rfc7231#section-6.5.2)
 * @see [Specification → RFC 7231](https://webconcepts.info/specs/IETF/RFC/7231)
 */
 ...
 * (if any).
 *
 * @see [Documentation → RFC 7231 §6.5.3](https://datatracker.ietf.org/doc/html/rfc7231#section-6.5.3)
 * @see [Specification → RFC 7231](https://webconcepts.info/specs/IETF/RFC/7231)
 */
 ...
 *
 * @see [Documentation → RFC 7231 §6.5.4](https://datatracker.ietf.org/doc/html/rfc7231#section-6.5.4)
 * @see [Specification → RFC 7231](https://webconcepts.info/specs/IETF/RFC/7231)
 */
 ...
 * supported methods.
 *
 * @see [Documentation → RFC 7231 §6.5.5](https://datatracker.ietf.org/doc/html/rfc7231#section-6.5.5)
 * @see [Specification → RFC 7231](https://webconcepts.info/specs/IETF/RFC/7231)
 */
 ...
 * representation.
 *
 * @see [Documentation → RFC 7231 §6.5.6](https://datatracker.ietf.org/doc/html/rfc7231#section-6.5.6)
 * @see [Specification → RFC 7231](https://webconcepts.info/specs/IETF/RFC/7231)
 */
 ...
 *
 * @see [Documentation → RFC 7235 §3.2](https://datatracker.ietf.org/doc/html/rfc7235#section-3.2)
 * @see [Specification → RFC 7235](https://webconcepts.info/specs/IETF/RFC/7235)
 */
 ...
 * new connection.
 *
 * @see [Documentation → RFC 7231 §6.5.7](https://datatracker.ietf.org/doc/html/rfc7231#section-6.5.7)
 * @see [Specification → RFC 7231](https://webconcepts.info/specs/IETF/RFC/7231)
 */
 ...
 *
 * @see [Documentation → RFC 7231 §6.5.8](https://datatracker.ietf.org/doc/html/rfc7231#section-6.5.8)
 * @see [Specification → RFC 7231](https://webconcepts.info/specs/IETF/RFC/7231)
 */
 ...
 *
 * @see [Documentation → RFC 7231 §6.5.9](https://datatracker.ietf.org/doc/html/rfc7231#section-6.5.9)
 * @see [Specification → RFC 7231](https://webconcepts.info/specs/IETF/RFC/7231)
 */
 ...
 *
 * @see [Documentation → RFC 7231 §6.5.10](https://datatracker.ietf.org/doc/html/rfc7231#section-6.5.10)
 * @see [Specification → RFC 7231](https://webconcepts.info/specs/IETF/RFC/7231)
 */
 ...
 *
 * @see [Documentation → RFC 7232 §4.2](https://datatracker.ietf.org/doc/html/rfc7232#section-4.2)
 * @see [Specification → RFC 7232](https://webconcepts.info/specs/IETF/RFC/7232)
 */
 ...
 *
 * @see [Documentation → RFC 7231 §6.5.11](https://datatracker.ietf.org/doc/html/rfc7231#section-6.5.11)
 * @see [Specification → RFC 7231](https://webconcepts.info/specs/IETF/RFC/7231)
 */
 ...
 * interpret.
 *
 * @see [Documentation → RFC 7231 §6.5.12](https://datatracker.ietf.org/doc/html/rfc7231#section-6.5.12)
 * @see [Specification → RFC 7231](https://webconcepts.info/specs/IETF/RFC/7231)
 */
 ...
 *
 * @see [Documentation → RFC 7231 §6.5.13](https://datatracker.ietf.org/doc/html/rfc7231#section-6.5.13)
 * @see [Specification → RFC 7231](https://webconcepts.info/specs/IETF/RFC/7231)
 */
 ...
 *
 * @see [Documentation → RFC 7233 §4.4](https://datatracker.ietf.org/doc/html/rfc7233#section-4.4)
 * @see [Specification → RFC 7233](https://webconcepts.info/specs/IETF/RFC/7233)
 */
 ...
 *
 * @see [Documentation → RFC 7231 §6.5.14](https://datatracker.ietf.org/doc/html/rfc7231#section-6.5.14)
 * @see [Specification → RFC 7231](https://webconcepts.info/specs/IETF/RFC/7231)
 */
 ...
 *
 * @see [Documentation → RFC 2324 §2.3.2](https://datatracker.ietf.org/doc/html/rfc2324#section-2.3.2)
 ...
 *
 * @see [Documentation → RFC 7540 §9.1.2](https://datatracker.ietf.org/doc/html/rfc7540#section-9.1.2)
 ...
 *
 * @see [Documentation → RFC 4918 §11.2](https://datatracker.ietf.org/doc/html/rfc4918#section-11.2)
 * @see [Specification → RFC 4918](https://webconcepts.info/specs/IETF/RFC/4918)
 */
 ...
 *
 * @see [Documentation → RFC 4918 §11.3](https://datatracker.ietf.org/doc/html/rfc4918#section-11.3)
 * @see [Specification → RFC 4918](https://webconcepts.info/specs/IETF/RFC/4918)
 */
 ...
 *
 * @see [Documentation → RFC 4918 §11.4](https://datatracker.ietf.org/doc/html/rfc4918#section-11.4)
 * @see [Specification → RFC 4918](https://webconcepts.info/specs/IETF/RFC/4918)
 */
 ...
 * data.
 *
 * @see [Documentation → RFC 8470 §5.2](https://datatracker.ietf.org/doc/html/rfc8470#section-5.2)
 ...
 * required protocol(s).
 *
 * @see [Documentation → RFC 7231 §6.5.15](https://datatracker.ietf.org/doc/html/rfc7231#section-6.5.15)
 * @see [Specification → RFC 7231](https://webconcepts.info/specs/IETF/RFC/7231)
 */
 ...
 *
 * @see [Documentation → RFC 6585 §3](https://datatracker.ietf.org/doc/html/rfc6585#section-3)
 * @see [Specification → RFC 6585](https://webconcepts.info/specs/IETF/RFC/6585)
 */
 ...
 *
 * @see [Documentation → RFC 6585 §4](https://datatracker.ietf.org/doc/html/rfc6585#section-4)
 * @see [Specification → RFC 6585](https://webconcepts.info/specs/IETF/RFC/6585)
 */
 ...
 *
 * @see [Documentation → RFC 6585 §5](https://datatracker.ietf.org/doc/html/rfc6585#section-5)
 * @see [Specification → RFC 6585](https://webconcepts.info/specs/IETF/RFC/6585)
 */
 ...
 * @see [Specification → RFC 7725](https://webconcepts.info/specs/IETF/RFC/7725)
 */
 ...
 *
 * @see [Documentation → RFC 7231 §6.6.1](https://datatracker.ietf.org/doc/html/rfc7231#section-6.6.1)
 * @see [Specification → RFC 7231](https://webconcepts.info/specs/IETF/RFC/7231)
 */
 ...
 *
 * @see [Documentation → RFC 7231 §6.6.2](https://datatracker.ietf.org/doc/html/rfc7231#section-6.6.2)
 * @see [Specification → RFC 7231](https://webconcepts.info/specs/IETF/RFC/7231)
 */
 ...
 *
 * @see [Documentation → RFC 7231 §6.6.3](https://datatracker.ietf.org/doc/html/rfc7231#section-6.6.3)
 * @see [Specification → RFC 7231](https://webconcepts.info/specs/IETF/RFC/7231)
 */
 ...
 *
 * @see [Documentation → RFC 7231 §6.6.4](https://datatracker.ietf.org/doc/html/rfc7231#section-6.6.4)
 * @see [Specification → RFC 7231](https://webconcepts.info/specs/IETF/RFC/7231)
 */
 ...
 *
 * @see [Documentation → RFC 7231 §6.6.5](https://datatracker.ietf.org/doc/html/rfc7231#section-6.6.5)
 * @see [Specification → RFC 7231](https://webconcepts.info/specs/IETF/RFC/7231)
 */
 ...
 *
 * @see [Documentation → RFC 7231 §6.6.6](https://datatracker.ietf.org/doc/html/rfc7231#section-6.6.6)
 * @see [Specification → RFC 7231](https://webconcepts.info/specs/IETF/RFC/7231)
 */
 ...
 *
 * @see [Documentation → RFC 4918 §11.5](https://datatracker.ietf.org/doc/html/rfc4918#section-11.5)
 * @see [Specification → RFC 4918](https://webconcepts.info/specs/IETF/RFC/4918)
 */
 ...
 *
 * @see [Documentation → RFC 2774 §7](https://datatracker.ietf.org/doc/html/rfc2774#section-7)
 ...
 *
 * @see [Documentation → RFC 6585 §6](https://datatracker.ietf.org/doc/html/rfc6585#section-6)
 * @see [Specification → RFC 6585](https://webconcepts.info/specs/IETF/RFC/6585)
 */
